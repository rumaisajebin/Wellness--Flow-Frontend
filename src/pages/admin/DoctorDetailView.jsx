...
const DoctorDetailView = () => {
  ...
  const handleBlockUnblock = async (action) => {
    try {
      ...
      setDoctor({ ...doctor, user: { ...doctor.user, is_active: action !== 'block' } });
      Swal.fire({
        title: "Success",
          ...
          <CardBody>
            <Row>
              ...
              <Col md="8" className="text-start">
                ...
                <p>
                  <strong>Verification Status:</strong> {doctor.is_profile_verify}
                </p>
                ...
                <p>
                  <strong>Blocked:</strong> {doctor.user.is_active ? "No" : "Yes"}
                </p>
                <div>
                  <h4>Documents</h4>
